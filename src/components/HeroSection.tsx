        ...
        <div className="flex flex-1 items-center pt-8 sm:pt-12 md:pt-16 pointer-events-none">
          <div className="w-full max-w-7xl px-6 md:px-10 pointer-events-auto">
            <FadeIn delay={0.65} y={30}>
              <h1
                className="mt-4 sm:mt-6 md:mt-8 text-transparent bg-clip-text bg-gradient-to-r from-white via-[#F1F5F9] to-[#94A3B8] uppercase tracking-[-0.03em] leading-[0.95] break-words drop-shadow-[0_0_30px_rgba(255,255,255,0.18)] drop-shadow-[0_0_15px_rgba(52,211,153,0.12)] transition-all duration-1000 origin-left scale-100 font-black opacity-100"
                style={{ fontSize: 'clamp(2.5rem, 8.5vw, 150px)' }}
              >
                <ScrambleText text="Hafsa Maryam" delay={0.8} />
              </h1>
            </FadeIn>
            ...
            <FadeIn delay={1.0} y={20}>
              <div className="mt-8 md:mt-12">
                <a
                  href="/Hafsa_Resume.pdf"
                  download="Hafsa_Resume.pdf"
