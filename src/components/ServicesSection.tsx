...
const SERVICES = [
  {
    ...
    description:
      'Building robust backend systems, automating processes, and developing intelligent applications using Python and its extensive ecosystem.',
  },
  {
    number: '02',
    title: 'AI/ML Engineering',
    description:
      'Implementing machine learning models, OCR solutions (Tesseract), and integrating Generative AI APIs (Gemini, OpenAI) to create smart, data-driven applications.',
  },
  {
    number: '03',
    title: 'Full-Stack Web Development',
    description:
      'Designing and developing responsive web applications using React, Node.js, and Laravel, focusing on clean architecture and user experience.',
  },
  {
    number: '04',
    title: 'Software Engineering',
    description:
      'Architecting scalable software solutions, designing complex databases including Neo4j graph databases, and ensuring robust system design.',
  },
];
