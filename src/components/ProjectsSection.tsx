...
const PROJECTS: ProjectData[] = [
  {
    ...
    name: 'ARdent Study',
    liveUrl: 'https://github.com/hafsamaryam08/ARdent-Study',
    col1Image1: '/ardent1.jpg',
    col1Image2: '/ardent2.jpg',
    col2Image: '/ardent3.jpg',
  },
  {
    number: '02',
    category: 'Web Technologies',
    name: 'Kaffen - Cafe & Restaurant',
    liveUrl: 'https://github.com/hafsamaryam08/Kaffen-Cafe-and-Restaurant',
    col1Image1: '/kaffen1.JPG',
    col1Image2: '/kaffen2.JPG',
    col2Image: '/kaffen3.JPG',
  },
  {
    number: '03',
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:justify-between gap-3 sm:gap-6">
          ...
          <a
            ...
            className="group flex h-12 w-12 sm:h-16 sm:w-16 shrink-0 items-center justify-center rounded-full bg-white transition-all hover:scale-110 shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] self-start sm:self-center"
            aria-label={`View ${project.name} on GitHub`}
          >
            <Github className="h-6 w-6 sm:h-7 sm:w-7 text-black transition-transform group-hover:rotate-12" strokeWidth={2} />
          </a>
        </div>
